...
def test_amount_between_100m_and_350m_without_overdraft_info_is_unknown() -> None:
    result = evaluate_product(
        _request(is_overdraft_type=None, requested_amount=Decimal("200000000")), REGISTRY
    )
